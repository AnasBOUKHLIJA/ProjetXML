                                ...
                                <?php foreach (AgentScolariteController::getAll() as $agentScolarite){ ?>
                                    <tr>
                                        <td>
                                            <?php if(!empty($agentScolarite['Photo']) && is_file($agentScolarite['Photo'])){ ?>
                                                <img class="rounded-circle me-2" width="30" height="30" src="<?php echo '/ProjetXML/'.$agentScolarite['Photo'];?>">
                                            <?php }else{ ?>
                                        ...
                                        <td>
                                            <?php if (PermissionController::get($_SESSION['code'])['Removeagentscolarite'] == 1) { ?>
                                                <button class="btn bg-transparent border-0" onclick="supprimer('agent','<?php echo $agentScolarite['Code']; ?>')">
                                    ...
                                    <div class="popup-modal-1">
                                        <div class="popup-window-1 bg-white shadow w-75 rounded-1">
                                                <?php if(!empty($agentScolarite['Photo']) && is_file($agentScolarite['Photo'])){ ?>
                                                    <img class="shadow img-user" src="<?php echo '/ProjetXML/'.$agentScolarite['Photo'];?>">
                                                <?php }else{ ?>
                                                    <img class="shadow img-user" src="/ProjetXML/views/ourAssets/images/etudiant.png">
                                                <?php } ?>
                                            <form method="POST" action="">
                                                <div class="card flex-row flex-wrap justify-content-evenly border-0" style="padding-top: 120px; ">
                                                    ...
                                                    <div class="m-3 mb-5" style="width: 44%;">
                                                        ...
                                                        <input class="form-control" id="tele"  value="<?php echo $agentScolarite['Telephone']?>" disabled>
                                                    </div>
                                                </div>
