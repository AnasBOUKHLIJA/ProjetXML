<?php
if (PermissionController::get($_SESSION['code'])['Addprofesseur'] == 0){
...
if(isset($_POST['submit'])){
    ProfesseurController::add($_POST);
}
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="card shadow">
                                <div class="card-body text-center d-flex flex-column align-items-center">
                                    <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4">
                                        <img src="/ProjetXML/views/ourAssets/images/prof.png" style="width: 100%;height: 100%">
                                    </div>
                                    <h1 class="text-dark mb-0 align-content-center ">Ajouter un Professeur</h1>
                                    <form method="post" enctype="multipart/form-data" action="" class="w-100 d-flex flex-row flex-wrap justify-content-evenly">
                                        ...
                                        <div class="m-2 d-flex flex-wrap justify-content-start" style="width: 46%">
                                            <label for="NumeroSomme">Numero de Somme</label>
                                            <input class="form-control" type="text" id="NumeroSomme" name="numerosomme" placeholder="Numero de Somme">
                                        </div>
                                        <div class="m-2 d-flex flex-wrap justify-content-start" style="width: 46%">
                                            <label for="Departement">Departement</label>
                                            <select class="form-control" id="Departement" name="departement">
                                                <?php foreach (DepartementController::getAll() as $departement){ ?>
                                                    <option value="<?php echo $departement->attributes()->Code  ?>"><?php echo $departement->Departement ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="m-2 d-flex flex-wrap justify-content-start" style="width: 46%">
