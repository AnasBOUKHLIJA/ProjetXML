<?php
if (PermissionController::get($_SESSION['code'])['Addfiliere'] == 0){
                            ...
                            <div class="card shadow">
                                <div class="card-body text-center d-flex flex-column align-items-center">
                                    <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4">
                                        <img src="/ProjetXML/views/ourAssets/images/filiere.jpg" class="rounded" style="width: 100%;height: 100%">
                                    </div>
                                    <h1 class="text-dark mb-0 align-content-center ">Ajouter une Filiere</h1>
